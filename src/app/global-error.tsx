  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Critical Error - SmartStartPM</title>
        <style>{`
          * {
            margin: 0;
            padding: 0;
          ...
          <div className="content">
            ...
            <div className="footer">
              ...
              <div className="footer-links">
                <a href="mailto:support@smartstart.us" className="footer-link">
                  Contact Support
                </a>
                <a href="/docs" className="footer-link">
                  Documentation
                </a>
                <a href="https://smartstart.us/status" className="footer-link" target="_blank" rel="noopener noreferrer">
                  System Status
                </a>
              </div>
            </div>
