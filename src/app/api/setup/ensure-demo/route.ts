...
const DEMO_ACCOUNTS = [
  { email: "superadmin@smartstartpm.com", password: "Sspm!Super2026", firstName: "Super", lastName: "Admin", role: "admin", phone: "+1234567890", isActive: true, emailVerified: new Date() },
  { email: "pmadmin@smartstartpm.com", password: "Sspm!Manager2026", firstName: "PM", lastName: "Admin", role: "manager", phone: "+1234567891", isActive: true, emailVerified: new Date() },
  { email: "owner@smartstartpm.com", password: "Sspm!Owner2026", firstName: "Property", lastName: "Owner", role: "owner", phone: "+1234567894", isActive: true, emailVerified: new Date() },
  { email: "tenant@smartstartpm.com", password: "Sspm!Tenant2026", firstName: "Smart", lastName: "Tenant", role: "tenant", phone: "+1234567892", isActive: true, emailVerified: new Date(), dateOfBirth: new Date("1990-01-01"), tenantStatus: "active", backgroundCheckStatus: "approved", creditScore: 720, employmentInfo: { employer: "Tech Corp", position: "Software Engineer", income: 75000, startDate: new Date("2020-01-01") }, emergencyContacts: [{ name: "Emergency Contact", relationship: "Family", phone: "+1234567893", email: "emergency@example.com" }] },
];
