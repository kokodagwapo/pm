...
function AIHelpContent() {
  ...
  const assistant = searchParams.get("assistant") as "luna" | null;
    ...
    <div className="container max-w-4xl mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Chat with Luna, your AI assistant, for instant help
        </p>
      </div>
      <AIAssistantChat initialAssistant={assistant || "luna"} />
    </div>
  );
}
