/**
 * SmartStartPM - Invoice Email Template
  ...
  return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
          <h1 style="margin: 0; font-size: 28px; font-weight: 300;">SmartStartPM</h1>
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <div style="border-top: 1px solid #eee; padding-top: 20px; margin-top: 30px; color: #666; font-size: 14px;">
            ...
            <p style="margin-bottom: 0;">Best regards,<br>SmartStartPM Management Team</p>
          </div>
        </div>
        
        <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
          <p>This email was sent from SmartStartPM Property Management System.</p>
          <p>© ${new Date().getFullYear()} SmartStartPM. All rights reserved.</p>
        </div>
      </div>
    `;
}
