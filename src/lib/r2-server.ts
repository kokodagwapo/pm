/**
 * SmartStartPM - Cloudflare R2 Server-Side Utilities
...
export async function uploadBrandingAsset(
  ...
  try {
    ...
    const objectKey = `SmartStartPM/branding/${type}s/${sanitizedFilename}`;
...
export async function uploadToR2(
  ...
  try {
    ...
    // Object key (path in R2)
    const folder = options.folder || "SmartStartPM/uploads";
