/**
 * SmartStartPM - Demo Data Service
...
export class DemoDataService {
  ...
  private async createDemoMessages(
    ...
    const messageTemplates = [
      {
        subject: "Welcome to SmartStartPM",
        content:
  ...
  private async createDemoAnnouncements(adminUser: any): Promise<any[]> {
    const announcementTemplates = [
      {
        title: "Welcome to SmartStartPM Demo",
        content:
          "Welcome to the SmartStartPM demo! This system includes sample data to help you explore all features. Feel free to test all functionality.",
        priority: "normal",
        type: "general",
      },
      {
