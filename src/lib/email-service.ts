...
export class EmailService {
  ...
  constructor() {
    ...
    this.appName = process.env.APP_NAME || "SmartStartPM";
...
© ${new Date().getFullYear()} ${this.appName}. All rights reserved.
  ...
  async sendTenantInvitation(
    ...
    const template = this.generateBaseTemplate(
      "Welcome to SmartStartPM - Complete Your Account Setup",
      content,
      {
  ...
  async sendPasswordReset(
    ...
    const template = this.generateBaseTemplate(
      "Reset Your SmartStartPM Password",
      content,
      {
  ...
  async sendAccountActivated(
    ...
    const template = this.generateBaseTemplate(
      "Your SmartStartPM Account is Ready!",
      content,
      {
