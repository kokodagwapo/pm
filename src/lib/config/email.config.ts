/**
 * SmartStartPM - Email Configuration
...
export const communicationConfig = {
  ...
  contactInfo: {
    ...
    email: process.env.CONTACT_EMAIL || "support@SmartStartPM.com",
    supportEmail: process.env.SUPPORT_EMAIL || "support@SmartStartPM.com",
  },
};
