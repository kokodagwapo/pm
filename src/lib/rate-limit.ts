/**
 * SmartStartPM - Rate Limiting Utility
...
export function addSecurityHeaders(response: Response): Response {
  ...
  response.headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; frame-ancestors 'self' *.replit.dev;"
  );
